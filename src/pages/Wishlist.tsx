    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-muted/20">
        <div className="container mx-auto px-4 py-16">
          <h1 className="text-4xl md:text-5xl font-oswald font-bold mb-8 text-center">
            My Wishlist
          </h1>
          <div className="max-w-md mx-auto text-center py-16">
            <Heart className="h-24 w-24 mx-auto mb-6 text-muted-foreground/30" />
            <h2 className="text-2xl font-oswald font-bold mb-4">Your wishlist is empty</h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-4xl md:text-5xl font-oswald font-bold">
              My Wishlist
            </h1>
              ...
              >
                ...
                <div className="p-6">
                  <Link to={`/product/${product.id}`}>
                    <h3 className="font-oswald font-bold text-xl mb-2 hover:text-primary transition-colors">
                      {product.name}
                    </h3>
                  </Link>
                  <p className="text-2xl font-oswald font-bold text-primary mb-4">
