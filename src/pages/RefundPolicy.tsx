    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-5xl font-oswald font-bold mb-2">Refund Policy</h1>
              ...
              >
                <div className="bg-card p-6 rounded-2xl shadow-elegant hover-lift h-full">
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-oswald font-bold mb-2">{step.title}</h3>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="space-y-8">
            {sections.map((section, index) => (
              ...
              >
                <h2 className="text-3xl font-oswald font-bold mb-6 text-gradient-gold">
                  {section.title}
                </h2>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            <h2 className="text-3xl font-oswald font-bold mb-4">Questions About Refunds?</h2>
