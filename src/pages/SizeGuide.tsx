...
>
  ...
  <div className="container mx-auto px-4 relative z-10">
    ...
    >
      ...
      <h1 className="text-5xl font-oswald font-bold mb-4">Size Guide</h1>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-oswald font-bold">Ring Size Chart</h2>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-oswald font-bold">Bracelet Size Guide</h2>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-oswald font-bold mb-8">Necklace Length Guide</h2>
