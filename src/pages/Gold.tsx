...
const Gold = () => {
  ...
  // 🔁 Re-filter when dependencies change (debounced)
  useEffect(() => {
  ...
  const handlePriceRangeChange = (range: [number, number]) => setPriceRange(range);
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-oswald font-bold mb-4 bg-gradient-to-br from-yellow-300 via-amber-200 to-yellow-500 bg-clip-text text-transparent drop-shadow-[0_3px_10px_rgba(0,0,0,0.6)]">
              Gold Collection
            </h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="py-12">
          <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
            <div>
              <h2 className="text-3xl font-oswald font-bold mb-2">Explore Our Gold Jewelry</h2>
          ...
          {featuredProducts.length > 0 && (
            <div className="mt-10">
              <h3 className="text-2xl font-semibold mb-4 text-amber-600">✨ Featured Pieces</h3>
              <motion.div
                layout
