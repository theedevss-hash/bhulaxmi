...
>
  ...
  <div className="relative z-10 container mx-auto px-4 text-center">
    ...
    >
      ...
      <h1
        className="text-6xl md:text-8xl font-serif font-bold mb-4 bg-gradient-to-br from-yellow-300 via-amber-200 to-yellow-500 bg-clip-text text-transparent drop-shadow-[0_3px_10px_rgba(0,0,0,0.6)]"
      >
        Gold Collection
      </h1>
