...
const Index = () => {
        ...
        <div className="relative z-10 container mx-auto px-4 text-center mt-8">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-6xl md:text-8xl font-oswald font-bold mb-4 text-gradient-gold"
            >
              Welcome to
            </motion.h1>
            ...
            <motion.div
              ...
              className="mb-6"
            >
              <h2 className="text-5xl md:text-7xl font-oswald font-bold text-white mb-2 drop-shadow-lg">
                Bhulaxmi Jewellers Private Limited
              </h2>
              <div className="h-1 w-32 mt-8 luxury-gradient mx-auto rounded-full" /> <br></br>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-2xl md:text-3xl font-oswald mb-7 text-white text-muted-foreground font-light tracking-wide"
            >
  ...
  <div className="absolute inset-0 bg-black/30 rounded-xl group-hover:bg-black/10 transition-all duration-500"></div>
                        ...
                        {/* Title */}
                        <h3 className={`text-3xl font-oswald font-bold mb-2 ${category.textColor}`}>
                          {category.title}
                        </h3>
