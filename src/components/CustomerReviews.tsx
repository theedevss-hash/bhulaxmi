...
export const CustomerReviews = () => {
  ...
  return (
    <div className="mt-12 space-y-8">
      <div>
        <h2 className="text-3xl font-oswald font-bold mb-6">Customer Reviews</h2>

        {/* Rating Summary */}
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div className="text-center p-6 bg-card rounded-xl border border-border/50">
            <div className="text-5xl font-oswald font-bold mb-2">{averageRating}</div>
        ...
        <div className="p-6 bg-card rounded-xl border border-border/50 mb-8">
          <h3 className="text-xl font-oswald font-bold mb-4">Write a Review</h3>
